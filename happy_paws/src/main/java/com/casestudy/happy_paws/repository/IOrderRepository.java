...
public interface IOrderRepository extends JpaRepository<Orders, Long> {
    @Query(value = "select o from Orders o inner join OrderDetail od on o.id = od.order.id where o.customer.name like :name and o.customer.phone like :phone group by o.id")
    ...
    @Query(value = "select o from Orders o inner join OrderDetail od on o.id = od.order.id  group by o.id")
